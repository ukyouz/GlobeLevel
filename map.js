!function() {
    ...
    d3.geoZoom = function() {
        ...
        var h,
            ...
            p,
            v = 0,
            g = u(m, "start", "zoom", "end"),
            m = d3.zoom().on("start", function() {
                var r = d3.mouse(this),
                    i = e(h.rotate()),
                    u = n(h, r);
    ...
    function t(t, n, e) {
        var a = n.projection();
        t.append("path").datum(d3.geoGraticule()).attr("class", "graticule").attr("d", n), t.append("path").datum({
            type: "Sphere"
    ...
    function n(t, n) {
        return d3.geoOrthographic().precision(.5).clipAngle(90).clipExtent([[-1, -1], [t + 1, n + 1]]).translate([t / 2, n / 2]).scale(t / 2 - 10).rotate([0, -30])
    }
    var e = 180 / Math.PI,
        a = 1e3,
        o = 600,
        r = d3.dispatch("world"),
        c = -1;
    d3.selectAll("#map, #eisenlohr").data([n(a, o).scale(245).translate([a / 2, .56 * o]), d3.geoEisenlohr().precision(.1).clipExtent([[-1, -1], [a + 1, o + 1]]).translate([a / 2, o / 2]).scale(75).rotate([0, -30])]).append("svg").attr("width", a).attr("height", o).each(function(n) {
        var e = d3.geoPath().projection(n),
            a = d3.select(this).call(t, e, !0);
        a.selectAll(".foreground").call(d3.geoZoom().projection(n).scaleExtent([.7 * n.scale(), 10 * n.scale()]).on("zoom.redraw", function() {
        ...
        var a = 350,
            ...
            c = n(a, o),
            i = n(a, o),
            s = d3.geoPath().projection(c),
            l = d3.geoPath().projection(i),
            u = d3.select("#comparison").append("svg").attr("width", a).attr("height", o).call(t, s, !0);
        u.selectAll(".foreground").call(d3.drag().origin(function() {
            var t = c.rotate();
            return {
                x: t[0],
                y: -t[1]
        ...
        d.selectAll(".foreground").call(d3.geoZoom().projection(i).on("zoom", e)), r.on("world.comparison0", function() {
        ...
        function a(e, a, u) {
            ...
            var m = d3.drag().on("drag", function() {
    ...
    }(), d3.json("world.topo.json", function(t, n) {
